...
class Client(models.Model):
    ...
    house_num = models.CharField(max_length=20, blank=True, verbose_name="Номер дома")
    flat_num = models.CharField(max_length=20, blank=True, verbose_name="Номер квартиры")
