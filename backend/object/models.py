...
class Object(models.Model):
    client_id = models.ForeignKey(Client,
                                    related_name='objects_by_client', on_delete=models.CASCADE, blank=True, verbose_name="Клиент")
    property_type_id = models.ForeignKey(PropertyType,
                                    related_name='objects_by_property', on_delete=models.CASCADE, blank=True, verbose_name="Тип собственности")
    object_type_id = models.ForeignKey(ObjectType,
                                    related_name='objects_by_type', on_delete=models.CASCADE, blank=True, verbose_name="Тип обьекта")
